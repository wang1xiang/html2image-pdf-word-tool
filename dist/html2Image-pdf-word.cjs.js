...
var htmlDocxJsTypescript = require('html-docx-js-typescript');
...
function exportAsWord(selector, filename) {
    ...
    return new Promise(async (resolve) => {
        ...
        htmlDocxJsTypescript.asBlob(htmlString, { margins }).then((data) => {
 ...
 * @returns Promise
 */
function exportAsImage(selector, filename, watermarkText) {
    const cloneEle = cloneElement(selector);
    if (!cloneEle)
        return Promise.reject();
    if (watermarkText) {
...
exports.exportAsWord = exportAsWord;
